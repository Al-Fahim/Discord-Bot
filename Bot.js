...
client.on('messageCreate', async (message) => {
  ...
  if (message.content.toLowerCase().includes('no')) {
    // Reply with the image
    await message.reply({files: ['https://cdn.discordapp.com/attachments/428407688469151745/1188714432042377356/image.png?ex=65a4c215&is=65924d15&hm=e0e9a13ba6d46f5af819def9775ce6ae93bedfce113a9cb0f11568bd31b52819&'] });
  }
